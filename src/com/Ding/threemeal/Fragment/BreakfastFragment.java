...
public class BreakfastFragment extends Fragment implements OnTouchListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View mView = inflater.inflate(R.layout.alarm_breakfast_layout, container, false);
		...
		HourPicker.setValue(mSharedPreferences.getInt("BREAKFAST_HOUR", 0));
		HourPicker.setOnNumberTouchListener(mOnNumberTouchListener);
		DINGUtil.setNumberPickerTextColor(HourPicker, Color.parseColor("#006ca3"));
		...
		MinutePicker.setValue(mSharedPreferences.getInt("BREAKFAST_MINUTE", 0));
		MinutePicker.setOnNumberTouchListener(mOnNumberTouchListener);
		DINGUtil.setNumberPickerTextColor(MinutePicker, Color.parseColor("#006ca3"));
		return mView;
	}
