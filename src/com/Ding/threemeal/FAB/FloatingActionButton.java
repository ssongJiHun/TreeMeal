package com.Ding.threemeal.FAB;
...
//		});	
	...
	void updateBackground() {
		...
		layerDrawable.setLayerInset(3, circleInsetHorizontal + iconOffset, circleInsetTop + iconOffset, circleInsetHorizontal + iconOffset,
	...
	private StateListDrawable getStateIconDrawable() {
		Drawable mDrawable = getIconDrawable();
		...
		StateListDrawable drawable = new StateListDrawable() {
			...
			protected boolean onStateChange(int[] stateSet) {
				...
				TextView mTextView = getLabelView();
				if (isStatePressedInArray) {
					super.setColorFilter(getResources().getColor(R.color.floatingColor), PorterDuff.Mode.MULTIPLY);
					if (mTextView != null) {
						mTextView.setTextColor(getResources().getColor(R.color.floatingColor));
						mTextView.setBackgroundResource(R.drawable.fab_label_background_pressed);
					}
					...
					if (mTextView != null) {
						mTextView.setTextColor(getResources().getColor(R.color.floatingPressed));
						mTextView.setBackgroundResource(R.drawable.fab_label_background);
		...
		drawable.addState(new int[] { android.R.attr.state_pressed }, mDrawable);
		drawable.addState(new int[] {}, mDrawable);
